...
const Imovel = () =>
{
    ...
    useEffect(() => {
      ...
      async function loginToken(){
        ...
        const res_acesso = await api.get("/pessoa/token", config)
        console.log(res_acesso.data);
        console.log(res_acesso.data.nivel_acesso);
        await setNivel_Acesso(res_acesso.data.nivel_acesso);
                ...
                <div className='direito'>
                    ...
                    <div className='infos'>
                        ...
                        <div className='valores'>
                                <p>Valor Minimo: R$ {imovel && imovel.valor_minimo}</p>
                                <p>Valor: R$ {imovel && imovel.valor}</p>
                        </div>
                    </div>
                    { Nivel_Acesso === "1"?
